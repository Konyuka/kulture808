                ...
                <div className="container max-w-7xl mx-auto px-4">
                    <div className="flex flex-wrap text-center lg:text-left pt-6">
                        <div className="w-full lg:w-6/12 px-4">
                            <H5 color="gray">Kulture 808s</H5>
                            <div className="-mt-4">
                                <LeadText color="blueGray">
                                    True definition of a World Class Studio 
                                </LeadText>
                            </div>
                            <div className="flex gap-2 mt-6 md:justify-start md:mb-0 mb-8 justify-center">
                                <a
                                    href="https://www.facebook.com/kulture808s"
                                ...
                                <a
                                    href="https://www.instagram.com/kulture808s/"
                                    className="grid place-items-center bg-white text-pink-500 shadow-md font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    <Icon
                                ...
                                <a
                                    href="https://www.youtube.com/channel/UCEDhqJTZ_iHznakpDIB9RCA"
                                ...
                                <a
                                    href="mailto:kulture808s@gmail.com"
                                    className="grid place-items-center bg-white text-red-600 shadow-md font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div className="text-sm text-gray-700 font-medium py-1">
                                Copyright © {new Date().getFullYear()} Kulture
                                808s Website by{' '}
                                <a
                                    href="mailto:michaelsaiba84@gmail.com"
                                    className="text-blue-500 hover:text-gray-900 transition-all"
                                >
                                    Michael Saiba
                                </a>
                                .
